        ...
        <div className="flex items-center">
          {tabs?.map((r, index) => (
            ...
            <button
              key={index}
              type="button"
              className={`text-left text-sm md:text-base pl-2 md:pl-3 lg:pl-4 pr-4 md:pr-16 lg:pr-32 py-2 font-semibold ${
                r?.name === "Release Info"
                  ? "border-b-4 border-teal-400 bg-gray-200"
          ...
          <div className="flex flex-col items-center mt-4 space-y-4">
            ...
            <div className="text-left">
              ...
              <ul className="list-disc list-inside text-xs">
                ...
                <li>
                  For optimal results, ensure the image dimensions are N x N
                  pixels.(eg :1000 x 1000 , 2000 x 2000)
                </li>
              </ul>
            </div>
          </div>
                ...
                <Controller
                  ...
                  render={({ field }) => (
                    <input
                      ...
                      ref={field.ref}
                      className={`border-2 mt-2 px-3 py-2 placeholder-gray-400 text-gray-700 bg-white rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 w-full transition ease-in-out duration-150 ${
                        errors?.SubGenre ? "border-red-500" : "border-gray-300"
                      }`}
                      onChange={(e) => {
                        const capitalizedValue = toTitleCase(e.target.value);
                        field.onChange(capitalizedValue);
